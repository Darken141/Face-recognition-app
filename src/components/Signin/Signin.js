                ...
                <main className="pa4 white-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input onChange={this.onEmailChange} className="white pa2 input-reset b--white ba bg-transparent hover-bg-black hover-white w-100" type="email" name="email-address"  id="email-address" />
                        </div>
                        <div className="mv3">
